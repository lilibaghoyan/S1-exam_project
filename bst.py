# bst_contacts.py - Enhanced Version with Tree Visualizer
...
class BST:
    ...
    def print_tree(self):
        """Prints the tree structure sideways in a human-readable form."""
...
def print_menu():
    ...
    print("8) Quit")
    print("9) Show tree visual")   # NEW OPTION
...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            tree.print_tree()   # SHOW TREE VISUAL
